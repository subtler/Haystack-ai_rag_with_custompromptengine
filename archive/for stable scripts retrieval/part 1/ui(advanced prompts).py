...
if prompt := st.chat_input("How can I change my account details?"):
    ...
    with st.chat_message("assistant"):
        with st.spinner("Searching for answers..."):
            try:
                # --- KEY CHANGE 1: Correctly pass data to the pipeline ---
                # The 'prompt_engine' component expects a 'query' input.
                ...
                # The final, clean result is now in the 'parser' component's output.
                parsed_result = result["parser"]["result"]
                answer = parsed_result.get("answer", "No answer found.")
                references = parsed_result.get("references", [])
                
                # --- KEY CHANGE 3: Format the clean data directly ---
                # No more manual string splitting or regex is needed.
